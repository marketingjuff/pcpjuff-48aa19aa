        ...
        <Card className="border-l-4 border-l-green-500 bg-green-50/40 dark:bg-green-950/10">
          ...
          <CardContent className="grid gap-2 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 pt-0">
            ...
            <div className="lg:col-span-2">
              <Field label="Orçamento Comercial (n.º Orç / Nome Resp. / Empresa) *" invalid={missingVendor.has("orcamento")}><Input value={form.orcamento ?? ""} onChange={(e) => set("orcamento", e.target.value)} /></Field>
            </div>
